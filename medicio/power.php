...
<div id="wrapper">
    ...
    <section id="intro" class="intro">
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h4 class="h-light">提供 <span class="color">最新的資訊</span>給您</h4>
					</div>
						<div class="well well-trans">
						<div class="wow fadeInRight" data-wow-delay="0.1s">

						<ul class="lead-list">
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>寵物最新活動力資訊</strong><br />&nbsp;&nbsp;</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>即時了解寵物的需求</strong><br />&nbsp;&nbsp;</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>協助飼主注意寵物狀況</strong><br />&nbsp;&nbsp;</span></li>
						</ul>
		...
		<?php
			...
			$sql = "SELECT * FROM power WHERE account ='$account' ORDER BY date DESC,time DESC LIMIT 1";
			...
			while ($row = $result->fetch_row())
			{
				...
				{
					echo  "<font color=\"black\">$row[$i] </font></br>";
					if($row[$i]<30)
						if($row[$i]>=20)
